...
import android.widgepackage com.signalplay.tv
...
class HomeActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // =================================================================================
        // MÁGICA 1: OUVINTE EM TEMPO REAL. ATUALIZA A TELA SEM PRECISAR FECHAR O APP
        // =================================================================================
        db.collection("usuarios").whereEqualTo("usuario", username)
            .addSnapshotListener { snapshot, error ->
                if (error == null && snapshot != null && !snapshot.isEmpty) {
                    ...
                    // Se o catálogo de filmes já baixou da API, atualiza a prateleira na hora!
                    runOnUiThread {
        ...
        // =================================================================================
        // MÁGICA 2: CARREGA A API DO SERVIDOR APENAS UMA VEZ EM SEGUNDO PLANO
        // =================================================================================
    ...
    private fun renderizarContinuarAssistindo() {
        ...
        val processarItem = { item: FilmeItem ->
            ...
            if (progData != null) {
                ...
                // Sem frescura: Assistiu mais de 5 segundos, salva e mostra a porcentagem na barra.
                if (dur > 0L && pos > 5000L) {
    ...
    // =================================================================================
    // MÁGICA 3: VARREDURA FORÇA BRUTA. PUXA TUDO QUE ESTIVER INSTALADO NA TV BOX
    // =================================================================================
    private fun carregarAplicativosDaTV() {
        ...
        try {
            ...
            for (appInfo in packages) {
                ...
                // O Segredo: Se o aplicativo possui uma tela de abrir (Intent), ele entra na prateleira!
