...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configurarModalPerfil() // O Novo Modal!
    ...
    private fun configurarModalPerfil() {
        ...
        findViewById<TextView>(R.id.txtModalAvatar).text = extrairIniciais(firebaseUser)
        ...
        findViewById<Button>(R.id.btnModalLimparHist).setOnClickListener {
        ...
        findViewById<Button>(R.id.btnModalLimparFavs).setOnClickListener {
    ...
    private fun baixarCatalogoCompleto() {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val respVod = api.getVodStreams(xtUser, xtPass); val respSeries = api.getSeriesStreams(xtUser, xtPass); val respCanais = api.getLiveStreams(xtUser, xtPass)
    ...
    private fun renderizarAbaHome() {
        ...
        // 1. CONTINUAR ASSISTINDO (Usando o novo card XML com progress bar)
    ...
    // RENDERIZADOR ESPECIAL PARA CONTINUAR ASSISTINDO
    ...
    // --- FUNÇÕES REAPROVEITADAS DOS OUTROS TRILHOS ---
